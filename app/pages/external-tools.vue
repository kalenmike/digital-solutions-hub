...
const createTool = (title, description, icon, to) => {
...
const tools = [
  ...
  createTool(
    "GTmetrix",
    "Performance reports and insights valuable for optimization.",
    "i-lucide-zap",
    "https://gtmetrix.com/",
  ),
  createTool(
    "Whats My DNS",
    "Lookup DNS across multiple nameservers in different parts of the world.",
    "i-lucide-globe",
  ...
  createTool(
    ...
    "i-lucide-mail-question-mark",
    "https://www.mail-tester.com/",
  ),
  createTool(
    "Spell Checker",
    "Identifier potential spelling mistakes across your site.",
    "i-lucide-spell-check-2",
    "https://datayze.com/website-spell-checker",
  ),
  createTool(
    "Web Check",
    "Easily discover all  publically available information on your domain.",
    "i-lucide-shield-user",
    "https://web-check.xyz/",
  ),
  createTool(
    "Contrast Ratio",
    "Verify that your chosen colours are readable to your users.",
    "i-lucide-contrast",
    "https://www.siegemedia.com/contrast-ratio",
  ),
  createTool(
    "Tiny JPG",
    "Minimize your images to improve your page loading time.",
    "i-lucide-scaling",
    "https://tinyjpg.com/",
  ),
  createTool(
  ...
  createTool(
    ...
    "Check your website’s index status instantly.",
    "i-lucide-chart-line",
    "https://indexly.ai/google-index-checker",
  ),
  createTool(
    "Jina",
    "API that converts webpage to markdown.",
    "i-lucide-brain",
    "https://r.jina.ai/",
  ),
];
...
<template>
        ...
        >
          <div class="flex items-center justify-center h-full min-w-[64px]">
            <img
              :src="tool.img"
              :alt="tool.title"
              class="max-w-[64px] max-h-[64px] object-contain rounded-md shadow-sm"
              loading="lazy"
            />
          </div>
        </UPageCard>
  ...
  <UPageSection
    ...
    description="Found a tool that’s a total game-changer? Drop the link below and help us kill the 'boring software' vibe."
  >
    <UContainer>
      <div class="flex align-center justify-center max-w-xl mx-auto">
        ...
        >
          ...
          <UFormField label="Url" name="url" size="xl">
            <UInput
              v-model="state.url"
              placeholder="https://f-society.org"
              class="w-full"
            />
          </UFormField>
          ...
          <UFormField label="Message" name="message" size="xl">
            <UTextarea
              ...
              autoresize
              class="w-full"
              placeholder="Why is this tool worth a look? Give us the 'elevator pitch.'"
            />
          </UFormField>
