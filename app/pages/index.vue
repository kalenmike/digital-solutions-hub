...
<template>
  <div>
    ...
    <UPageSection id="about" class="md:px-16">
      ...
      <UContainer>
        ...
        <UContainer class="mt-20 justify-center flex gap-5">
          <UButton to="https://github.com/kalenmike" target="_blank" aria-label="GitHub" color="neutral"
            variant="ghost">
            <template #leading>
              <UIcon name="i-simple-icons-github" class="w-8 h-8" />
            </template>
          </UButton>
          <UButton to="https://www.linkedin.com/in/kalenmichael/" target="_blank" aria-label="LinkedIn" color="neutral"
            variant="ghost">
            <template #leading>
    ...
    <UPageSection id="services" title="Services"
    ...
    <UPageSection>
      <UPageCTA title="Your partner in digital growth."
    ...
    <UPageSection id="support" title="New to Technology?"
      ...
      <UCard variant="subtle">
        ...
        <UPageFeature title="I explain technical concepts in plain English. No jargon, no confusion!" description=" "
          icon="i-lucide-circle-check-big" />
        <UPageFeature title="Step-by-step guidance from idea to implementation" description=" "
          icon="i-lucide-circle-check-big" />
        <UPageFeature title="I act as your trusted technical advisor and translator" description=" "
          icon="i-lucide-circle-check-big" />
        <UPageFeature title="You stay in control while I handle the technical details" description=" "
          icon="i-lucide-circle-check-big" />
        <UPageFeature title="Regular updates and clear communication throughout our work together" description=" "
          icon="i-lucide-circle-check-big" />
        <UCard variant="subtle">
          <p class="text-xl">
    ...
    <UPageSection id="developers" title="For Technical Teams"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div class="flex flex-col h-full">
            <UForm :validate="validate" :state="state" class="space-y-4 flex-1" @submit="onSubmit">
              <UInput v-model="state._honey" type="text" name="_honey" style="display: none" tabindex="-1"
                autocomplete="off" />
              ...
              <div class="flex justify-end">
                <UButton type="submit" :loading="loading" icon="i-lucide-send" class="py-4" size="xl">
                  Send Message
                </UButton>
              </div>
            </UForm>
          ...
          <div class="lg:pl-12 space-y-8">
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">
                Based in your city, available worldwide. I usually respond
                within 24 hours.
              </p>
            </div>
